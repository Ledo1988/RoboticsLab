...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body .accordion').on('click', '.accordion__item', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('accordion__item--active')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('accordion__item--active');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents('.accordion').find('.accordion__item').removeClass('accordion__item--active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('accordion__item--active');
    }
  });
});
...
/***/ "./src/blocks/modules/header-burgermenu/header-burgermenu.js":
/*!*******************************************************************!*\
  !*** ./src/blocks/modules/header-burgermenu/header-burgermenu.js ***!
  \*******************************************************************/
/*! no exports provided */
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.burger-menu__button', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body header').toggleClass('header__mobile-open');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.main-slider', {
    navigation: {
...
function init() {
  var myMap = new ymaps.Map("map", {
    center: [59.95635376519322, 30.31010306085205],
    zoom: 17,
    controls: []
  });
  myMap.geoObjects.add(new ymaps.Placemark([59.95635376519322, 30.31010306085205], {
    iconCaption: 'Кронверкский пр-т, д.49'
  }, {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _js_import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../js/import/jquery.inputmask.min */ "./src/js/import/jquery.inputmask.min.js");
/* harmony import */ var _js_import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_1__);



jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#user-tel').inputmask('+7 (999) 999-99-99');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#user-email').inputmask({
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').on('click', '.modal__open-btn', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').find('.modal-request').fadeIn('slow');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__form').submit(function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      success: function success(response) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').find('.modal').fadeOut('slow');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__form').trigger("reset");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').find('.modal-thanks').fadeIn('slow');
      }
    });
    e.preventDefault();
  });
...
/***/ "./src/js/import/jquery.inputmask.min.js":
/*!***********************************************!*\
  !*** ./src/js/import/jquery.inputmask.min.js ***!
  \***********************************************/
/*! no static exports found */
...
!function webpackUniversalModuleDefinition(root, factory) {
  if ("object" == ( false ? undefined : _typeof2(exports)) && "object" == ( false ? undefined : _typeof2(module))) module.exports = factory(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
      ...
      if (opts.min) {
        if (dateParts.rawyear) {
          ...
          if (rawYear < minYear) {
            ...
            if (rawYear = "yyyy" === tokenMatch.targetMatch[0] ? dateParts.rawyear.substr(1, 1) : dateParts.rawyear.substr(0, 1), minYear = opts.min.year.substr(2, 1), 1 === rawYear.length && minYear <= rawYear) return "yyyy" === tokenMatch.targetMatch[0] ? (result.insert = [{
              pos: result.pos + 1,
              c: rawYear,
              strict: !0
    ...
    Inputmask.extendAliases({
      datetime: {
        ...
        postValidation: function postValidation(buffer, pos, c, currentResult, opts, maskset, strict) {
          ...
          return result && dateParts.date.getTime() == dateParts.date.getTime() && (result = prefillYear(dateParts, result, opts), result = isValidDate(dateParts, result), result = isDateInRange(dateParts, result, opts, maskset)), pos && result && currentResult.pos !== pos ? {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_main_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! %modules%/main-slider/main-slider */ "./src/blocks/modules/main-slider/main-slider.js");
...
/* harmony import */ var _modules_header_burgermenu_header_burgermenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! %modules%/header-burgermenu/header-burgermenu */ "./src/blocks/modules/header-burgermenu/header-burgermenu.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./import/jquery.inputmask.min */ "./src/js/import/jquery.inputmask.min.js");
/* harmony import */ var _import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_import_jquery_inputmask_min__WEBPACK_IMPORTED_MODULE_0__);
